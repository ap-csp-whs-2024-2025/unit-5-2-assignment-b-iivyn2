...
std::vector<std::sting> names = {"Peter", "Bruce", "Steve", "Tony", "Natasha", "Clint", "Wanda", "Hope", "Danny", "Carol"};
std::vector<int> numbers = {100,50,10,1,2,7,11,17,53,-8, -4, -9, -72, -64, -80};
    
//Problem 1 
int curr_index = 0;
while (curr_index <name.size())
{
